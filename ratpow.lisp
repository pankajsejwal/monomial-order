;;; ratpow 1.01
;;; 
;;; Copyright 2013 Stavros Macrakis
...
;;; ratp_dense_coeffs -- list of coefficients of the main variable
...
;;; ratp_dense_coeffs( expr, var ) => list of coefficients in ratnumer(expr)
;;; returned coefficients are in CRE form except for numbers
;;;  ratp_coeffs( 4*x^3 + x + sqrt(x), x) => [4,0,1,sqrt(x)]
